...
//    lazy var invidious = Invidious(instance: "https://invidious.fdn.fr", requestTimeout: TimeInterval(timeout))
    let invidious = Invidious.Cascading(instances: ["https://invidious.snopyta.org", "https://invidious.zee.li", "https://invidious.fdn.fr", "https://invidiou.site"], sessionTimeout: 8)
